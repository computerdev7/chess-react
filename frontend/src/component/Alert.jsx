...
export default function Alert({ username, gameResult }) {
    ...
    return (
        <>
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 h-50 w-72 md:h-60 md:w-96 p-2
             flex justify-center items-center flex-col gap-5 bg-yellow-200/70 rounded-xl backdrop-blur-md z-50">
                {
                    username ?
                        <>
                            <span className="flex justify-center items-center flex-col">
                                <p className="font-ChelseaMarket text-xl md:text-3xl text-yellow-900">choose username</p>
                            ...
                            <input className="w-3/5  p-1 rounded-lg outline-yellow-300 font-ChelseaMarket tracking-widest text-sm md:text-lg"
                            ...
                            <button className="border font-ChelseaMarket p-1 md:p-3 rounded-2xl w-24 bg-blue-400/70 text-white/70 hover:bg-blue-400/90 
                        ...
                        <>
                            ...
                            <div className="flex gap-5">
                                <button className="border border-green-600 text-white/100 text-lg md:text-2xl font-bold font-ChelseaMarket p-1 md:p-3 rounded-3xl bg-green-500 shadow-inner
                  outline-yellow-300/50 active:outline active:border-none hover:border-green-700 hover:bg-green-600 active:text-white/50"
                                ...
                                > restart </button>
                                <button className="border border-red-500 text-white/100 text-lg md:text-2xl font-bold font-ChelseaMarket p-1 md:p-3 rounded-3xl bg-red-400 shadow-inner
